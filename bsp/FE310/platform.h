...
#define PWM_S		0x10
#define PWM_CMP0	0x20	// PWM Period
#define PWM_CMP1 	0x24	// LED Red
#define PWM_CMP2 	0x28	// LED Green
#define PWM_CMP3 	0x2C	// LED Blue
...
// ------------------------------------------------------------------------------
#define BTN0  0 // connect external buttons to the Arduino shield GPIO pins
#define BTN1  0 // connect external buttons to the Arduino shield GPIO pins
#define BTN2  0 // connect external buttons to the Arduino shield GPIO pins

#define BTN0_IRQ 0 // connect external buttons to the Arduino shield GPIO pins
#define BTN1_IRQ 0 // connect external buttons to the Arduino shield GPIO pins
#define BTN2_IRQ 0 // connect external buttons to the Arduino shield GPIO pins
