...
#define CSRR(csr) 	  ({ unsigned long rd; asm volatile ("csrr %0, " #csr : "=r"(rd)); rd; })
#define CSRW(csr, rs) ({ asm volatile ("csrw " #csr ", %0" :: "r"(rs)); })
#define CSRS(csr, rs) ({ asm volatile ("csrs " #csr ", %0" :: "r"(rs)); })
#define CSRC(csr, rs) ({ asm volatile ("csrc " #csr ", %0" :: "r"(rs)); })
